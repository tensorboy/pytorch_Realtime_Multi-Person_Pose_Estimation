...
# model
openpose = OpenPose_Model(l2_stages=4, l1_stages=2, paf_out_channels=38, heat_out_channels=19)
# load pretrained
use_vgg(openpose)
model = rtpose_lightning(args, preprocess, target_transforms=None, model = openpose)
exp = Experiment(name='openpose', save_dir=args.log_dir)
